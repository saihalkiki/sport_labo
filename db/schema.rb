...
ActiveRecord::Schema.define(version: 2019_10_29_105537) do
  ...
  create_table "participations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["micropost_id"], name: "index_participations_on_micropost_id"
    t.index ["user_id", "micropost_id"], name: "index_participations_on_user_id_and_micropost_id", unique: true
